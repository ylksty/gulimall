...
import com.ylkget.gmall.order.dao.OrderItemDao;
...
//        //{"id":1,"name":"哈哈","sort":null,"status":null,"createTime":1581144531744}
//        System.out.println("接收到消息..."+content);
//        // 接收消息，不签收，服务中断，消息返回Ready状态
//    }

    @RabbitHandler
    public void recieveMessage2(Message message, OrderEntity content, Channel channel) throws InterruptedException {
        //{"id":1,"name":"哈哈","sort":null,"status":null,"createTime":1581144531744}
        System.out.println("接收到消息..."+content);
        // 接收消息，不签收，服务中断，消息返回Ready状态
        long deliveryTag = message.getMessageProperties().getDeliveryTag();
