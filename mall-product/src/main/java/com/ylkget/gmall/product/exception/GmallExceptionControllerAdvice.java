package com.ylkget.gmall.product.exception;
...
/**
 * 集中处理所有异常
 * @author joe 2021-02-01 21
 */
@Slf4j
//@ResponseBody
//@ControllerAdvice(basePackages = "com.ylkget.gmall.product.controller")
@RestControllerAdvice(basePackages = "com.ylkget.gmall.product.controller")
